...
mkdir -p ./lighthouse_performance/w_plugin
...
do
  ...
  pnpx lighthouse http://localhost:8000 --preset=desktop --output json --output-path=./lighthouse_performance/w_plugin/${TIMESTAMP}_w_plugin.json
